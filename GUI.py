...
class SettingsWidget(QtWidgets.QWidget):
    ...
    def settings_variables(self):
        # This needs to be initialized in order to be able to access the variables

        # Language:

        if self.conf["Language"]['german'] == 'true':
        ...
        if self.conf["AGB"]['accept'] == 'true':
            self.agb_accept = True

        elif self.conf["AGB"]["accept"] == 'false':
            self.agb_accept = False
...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def updates_labels(self):

        if self.conf["Language"]["not_set"] == 'true' or self.conf["Language"]["english"] == 'true':

            self.tp_link_networks_label.setText(str("TP-Link Networks: " + str(self.tp_link_length)))
            self.o2_networks_labe.setText(str("O2 Networks: " + str(self.o2_length)))
            self.wep_networks_label.setText(str("WEP Networks: " + str(self.wep_length)))
            self.wpa_networks_label.setText(str("WPA Networks: " + str(self.wpa_length)))
            self.in_total_networks_label.setText(str("In total: " + str(self.all_length)))

        elif self.conf["Language"]["german"] == 'true':

            self.tp_link_networks_label.setText(str("TP-Link Netzwerke: " + str(self.tp_link_length)))
            self.o2_networks_labe.setText(str("O2 Netzwerke: " + str(self.o2_length)))
            self.wep_networks_label.setText(str("WEP Netzwerke: " + str(self.wep_length)))
            self.wpa_networks_label.setText(str("WPA Netzwerke: " + str(self.wpa_length)))
            self.in_total_networks_label.setText(str("Insgesamt: " + str(self.all_length)))
